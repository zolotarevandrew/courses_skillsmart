...
public class SlidingWindowMaximumTests
{
    ...
    [Fact]
    public void RunDeque_Case1_ShouldBeOk( )
    {
        // Arrange
        var arr = new int[]
        {
        ...
        // Act
        var res = SlidingWindowMaximum.RunDeque( arr, k );
    ...
    [Fact]
    public void RunDeque_Case2_ShouldBeOk( )
    {
        // Arrange
        var arr = new int[]
        {
    ...
    [Fact]
    public void RunDeque_Case3_ShouldBeOk( )
    {
        // Arrange
        var arr = new int[]
        {
