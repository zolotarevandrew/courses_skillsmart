...
namespace LinkedList_3.Tests
{
    public partial class LinkedListTests
    {
        ...
        [Fact]
        public void RemoveAll_ListHasTwoElementRemoveAtHead_ShouldReturnTrueAndCorrectTailHeadCount()
        {
            //Arrange
            var list = new LinkedList3();
        ...
        [Fact]
        public void RemoveAll_ListHasTwoElementRemoveAtTail_ShouldReturnTrueAndCorrectTailHeadCount()
        {
            //Arrange
            var list = new LinkedList3();
        ...
        public void RemoveAll_ListNotEmptyRemovedAtMiddleTwoTimes_ShouldReturnTrueAndCorrectTailHeadCount()
        {
            ...
            Assert.Equal(15, head.value);
            Assert.Equal(16, head.next.value);
            Assert.Equal(19, head.next.next.value);
