...
{
    public class QuickSortWithMemoryPartitionTests
    {
        [Fact]
        public void CalcPartition_TwoNumbers_ShouldBeOk()
        {
            ...
            var partition = QuickSortWithMemory.CalcPartition(arr);
            
            Assert.Equal(1, arr[0]);
            Assert.Equal(2, arr[1]);
            
            var leftSpan = partition.Left.Span;
            Assert.Equal(1, leftSpan.Length);
            Assert.Equal(1, leftSpan[0]);
            
            var rightSpan = partition.Right.Span;
        ...
        public void CalcPartition_SixNumbersUnsortedFirstThreeElements_ShouldBeOk()
        {
            ...
            var partition = QuickSortWithMemory.CalcPartition(arr.AsMemory(0..3));
        ...
        public void CalcPartition_SixNumbersUnsortedLastThreeElements_ShouldBeOk()
        {
            ...
            var partition = QuickSortWithMemory.CalcPartition(arr.AsMemory(3..6));
